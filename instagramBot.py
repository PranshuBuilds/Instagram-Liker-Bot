...
browser = webdriver.Chrome(executable_path= r"H:\chromedriver_win321\chromedriver.exe")  # <----- ENTER PATH HERE 
...
def start():
	...
	username.send_keys('raysroz')            # <- INSERT YOUR INSTAGRAM USERNAME HERE
	password = browser.find_element_by_name('password')
	password.send_keys('765gmail')            # <- INSERT YOUR INSTAGRAM PASSWORD HERE
